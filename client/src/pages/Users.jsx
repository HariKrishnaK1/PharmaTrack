...
import { Users as UsersIcon, Plus, Search, RefreshCw, ShieldCheck, UserX, UserCheck, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white max-w-md w-full p-6 rounded-2xl shadow-xl border border-slate-200">
            <h3 className="text-base font-bold text-slate-900 mb-4">Provision Operational Account</h3>
            <form onSubmit={handleCreateSubmit} className="space-y-3 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:border-teal-600 font-semibold"
                >
              ...
              <div className="flex items-center justify-end gap-2.5 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-2 font-semibold text-white bg-teal-600 hover:bg-teal-700 rounded-lg transition shadow-xs disabled:opacity-50"
                >
